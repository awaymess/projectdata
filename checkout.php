          ...
          <div class="col-md-12">
            ...
            <div class="p-3 p-lg-5 border">
                    ...
                    <form action="confrim.php" method="post">
                      <tbody>
                        <tr>
                          ...
                          <td>
                          <?= $row["nameorder"] ?> <?= $row["typeorder"] ?> เพิ่มเติม<?= $row["addonorder"] ?> ใส่วิปครีม<?= $row["addonwiporder"] ?> ใส่<?= $row["sizeorder"] ?> <?= $row["priceorder"] ?>
                          </td>
              ...
              <div class="form-group">
                ...
                <!-- <button class="btn btn-primary btn-lg btn-block" onclick="window.location='thankyou.html'">ยืนยัน</button> -->
              </div>
              </form>
              <button class="btn  btn-lg btn-block" onclick="history.back();">กลับ</button>
