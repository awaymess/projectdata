                    ...
                    <form class="col-md-12">
                        <div class="site-blocks-table">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="product-name">No Order</th>
                                        <th class="product-type">Name</th>
                                        <th class="product-price">Date</th>
                                        <th class="product-price">View</th>

                                    </tr>
                                </thead>
                                <tbody>

                                    <?php $stmt = $pdo->prepare("SELECT DISTINCT orders_id,orders.cususer,Rdate FROM orders,receipt where  orders.orders_id = receipt.Rid and orders.cususer = '$user' ORDER BY orders_id desc; ");
                                    $stmt->execute(); ?>
                                    ...
                                    <?php while ($row = $stmt->fetch()) { ?>
                                        <tr>
                                            ...
                                            <td><a href="myorderdetail.php?orders_id=<?= $row["orders_id"] ?>" class="btn btn-success">View</a></td>
