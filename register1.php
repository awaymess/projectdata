...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(jzar1s5arx631.jpg) no-repeat center center;">
            <div class="auth-box row text-center">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Sign Up
                        </h2>
                        <form class="mt-4" action="register.php" method="POST" >
                            <div class="row">
                            <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="cusname" type="text" placeholder="your name">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="custel" type="Phone Number" placeholder="Phone Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    Already have an account? <a href="login1.php" class="text-danger">Sign In</a>
                                </div>
                            </div>
                        </form>
                    </div>
