                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <form action="insartproduct1.php" method="post" enctype="multipart/form data">
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control" name="Pprice" type="number">

                                                    </td>
                                                    <td>
                                                        <select class="form-control" name="PStatus" value="มี">
                                                            <option value="มี">มี</option>
                                                            <option value="หมด">หมด</option>
                                                        </select>
                                                    </td>

                                                    <!-- <td><input class="btn btn-warning" type="file" name="photo"></td> -->
                                            ...
                                            if ($_FILES) {
                                                $name = $_FILES["photo"];
                                                move_uploaded_file($_FILES["photo"], $name);
                                            } ?> -->
