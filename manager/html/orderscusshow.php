...
<![endif]-->
    <script>
        function confirmDelete(CusTel) {
            var ans = confirm("ต้องการลบ " + CusTel);
            if (ans == true)
                document.location = "deledetcustom.php?CusTel=" + CusTel;
        }
    </script>
</head>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <form action="statusorder.php" method="post">
                                            <tbody>
                                                <?php
                                                $stmt = $pdo->prepare("SELECT * FROM orders where orders_id=? and status='1' ORDER BY idorder asc; ");
                                                ...
                                                <?php while ($row = $stmt->fetch()) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row["typeorder"] ?></td>
                                                        <td><?= $row["quaor"] ?></td>
                                                        <td><?= $row["addonorder"] ?></td>
                                                        <td><?= $row["addonwiporder"] ?></td>

                                                        <td><input type="submit" class="btn btn-success" value="เสร็จ" /></td>
                                                ...
                                                <?php while ($row = $stmt->fetch()) { ?>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                        <td class="btn btn-block btn-warning"><strong>Order Total</strong></td>
                                                        <td class="btn btn-block btn-dark"><strong><?= $row["sum(totalor)"]  ?>  Baht</strong></td>
                                                    </tr>
                                                <?php } ?>
