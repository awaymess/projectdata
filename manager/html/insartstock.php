                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <form action="insertstock1.php" method="post">
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control" name="SAmount" type="number">

                                                    </td>
                                                    <td>
                                                        <input class="form-control" name="SPrice" type="number">
                                                    ...
                                                    <input type="hidden" name="Sdate" value="<?= date("Y-m-d h:i:sa", $d) ?>">
