...
<![endif]-->
    ...
    <script>
        function confirmDelete(Pid) {
            ...
            if (ans == true)
                document.location = "deledetproduct.php?Pid=" + Pid;
        }
    </script>
</head>
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($row = $stmt->fetch()) { ?>
                                                <form action="updateproduct.php" method="post">
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="Pid" value="<?= $row["Pid"] ?>"><?= $row["Pid"] ?>
                                                        </td>
                                                        <td>
                                                            <input type="hidden" class="form-control" name="Pname" value="<?= $row["Pname"] ?>"><?= $row["Pname"] ?>
                                                        </td>
                                                        
                                                        <!-- <td><a href="javascript:void(0)" class="font-weight-medium link"><?= $row["Sname"] ?></a></td> -->
                                                        <td>
                                                            <input class="form-control" name="Pprice" value="<?= $row["Pprice"] ?>">
                                                        </td>
                                                        <td>
                                                            <select class="form-control" name="PStatus" value="<?= $row["PStatus"] ?>" >
                                                                <option><?= $row["PStatus"] ?></option>
