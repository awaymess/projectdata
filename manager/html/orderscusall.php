...
<![endif]-->
    <script>
        function confirmDelete(orders_id) {
            var ans = confirm("ต้องการลบ " + orders_id);
            if (ans == true)
                document.location = "deledetcusorder.php?orders_id=" + orders_id;
        }
    </script>
</head>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Orders All</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <?php $stmt = $pdo->prepare("SELECT DISTINCT orders_id,orders.cususer,Rdate FROM orders,receipt where  orders.orders_id = receipt.Rid ORDER BY orders_id desc; ");
                                            $stmt->execute(); ?>
                                            ...
                                            <?php while ($row = $stmt->fetch()) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="orderscusshowall.php?orders_id=<?= $row["orders_id"] ?>" class="btn btn-success">View</a></td>

                                                    
                                                    <!-- <td><a href='#' onclick='confirmDelete("<?= $row["orders_id"] ?>")' class="btn btn-danger">Cancel</a></td> -->
