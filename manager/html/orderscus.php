                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <?php $stmt = $pdo->prepare("SELECT DISTINCT orders_id,orders.cususer,Rdate FROM orders,receipt where  orders.orders_id = receipt.Rid and status = '1' ORDER BY orders_id desc; ");
                                            $stmt->execute(); ?>
                                            ...
                                            <?php while ($row = $stmt->fetch()) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="orderscusshow.php?orders_id=<?= $row["orders_id"] ?>" class="btn btn-success">View</a></td>
